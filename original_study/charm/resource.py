# -*- coding: utf-8 -*-
"""
Created on Wed Aug 11 19:55:43 2021
...
class IdResource(Resource):
    ...
    def __init__(self, env: Environment, capacity: int, rid: int, rtype: int):
        super().__init__(env, capacity)
        self._rid = rid
        self._rtype = rtype
...
r = IdResource(env, 0, 1, 21) 
r1 = IdResource(env, 2, 2, 22)
print('r capacity', r.capacity, 'r1 capacity', r1.capacity, r.rid, r1.rid, r.rtype, r1.rtype)

r.setCapacity(10)
r.setRtype(11)
r1.setRtype(33)
print('r capacity', r.capacity, 'r1 capacity', r1.capacity, r.rtype, r1.rtype) 

r.setCapacity(8)
r1.setCapacity(5)
print('r capacity', r.capacity, 'r1 capacity', r1.capacity)
